...
/**
 * `CustomHaxquizTheme`
 * `CustomHaxquizTheme based on modern flex design system`
 ...
 * @element custom-haxquiz-theme
 */
class CustomHaxquizTheme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
...
customElements.define(CustomHaxquizTheme.tag, CustomHaxquizTheme);
export { CustomHaxquizTheme };
