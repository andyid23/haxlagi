var Ut=(x,t)=>()=>{try{return t||x((t={exports:{}}).exports,t),t.exports}catch(e){throw t=0,e}};import{css as Bt,html as O}from"@haxtheweb/haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{PolarisFlexTheme as Ft}from"@haxtheweb/polaris-theme/lib/polaris-flex-theme.js";import"@haxtheweb/haxcms-elements/lib/ui-components/blocks/site-children-block.js";import{DDDSuper as E}from"@haxtheweb/d-d-d/d-d-d.js";import{LitElement as P,css as q,html as n}from"lit";import{I18NMixin as L}from"@haxtheweb/i18n-manager/lib/I18NMixin.js";var Dt=Ut((Yt,H)=>{class it extends Ft{static get styles(){return[super.styles,Bt`
        :host {
          display: block;
        }
        aside {
        ...
        <div class="flex-container">
          <div class="gauge-section">
            <div class="gauge-wrapper">
              <svg><circle class="bg-circle" cx="80" cy="80" r="${e}"></circle><circle class="fg-circle" cx="80" cy="80" r="${e}" stroke-dasharray="${a}" stroke-dashoffset="${s}"></circle></svg>
    ...
    `}}globalThis.customElements.define(rt.tag,rt);class dt extends L(E(P)){static get tag(){return"engagement-score"}static get properties(){return{...super.properties,appsScriptUrl:{type:String,attribute:"apps-script-url"},studentId:{type:String,attribute:"student-id"},_history:{state:!0}}}constructor(){super(),this.appsScriptUrl="",this.studentId="",this._history=[]}connectedCallback(){super.connectedCallback(),this._fetchHistory()}async _fetchHistory(){if(!this.appsScriptUrl||!this.studentId){this._history=[{date:F(),count:j().length}];return}try{const t=new URLSearchParams({action:"getActivityHistory",studentId:this.studentId,days:28}),e=await(await fetch(`${this.appsScriptUrl}?${t.toString()}`)).json();this._history=e.history||[]}catch(t){console.error("[engagement-score] Fetch failed:",t),this._history=[{date:F(),count:j().length}]}}_getActivityMap(){const t=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],e=new Date,a=[];for(let s=27;s>=0;s--){const d=new Date;d.setDate(e.getDate()-s);const l=`${d.getFullYear()}-${String(d.getMonth()+1).padStart(2,"0")}-${String(d.getDate()).padStart(2,"0")}`,b=this._history.find(I=>I.date===l),N=b?b.count:0;a.push({date:d,dateStr:l,dayName:t[d.getDay()],count:N})}return a}static get styles(){return[super.styles,q`:host { display: block; font-family: var(--ddd-font-primary); color: var(--ddd-theme-default-text); } .engagement-card { background: var(--ddd-theme-default-surface); border-radius: var(--ddd-radius-lg); padding: var(--ddd-spacing-6); border: 1px solid var(--ddd-theme-polaris-border); box-shadow: var(--ddd-shadow-1); } h3 { margin: 0 0 var(--ddd-spacing-3) 0; font-size: var(--ddd-font-size-l); color: var(--ddd-theme-primary); display: flex; align-items: center; gap: var(--ddd-spacing-2); } .consistency-stats { display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: var(--ddd-spacing-4); margin-bottom: var(--ddd-spacing-6); } .stat-mini-card { background-color: var(--ddd-theme-polaris-surface); border: 1px solid var(--ddd-theme-polaris-border); border-radius: var(--ddd-radius-md); padding: var(--ddd-spacing-4); display: flex; flex-direction: column; gap: var(--ddd-spacing-1); } .mini-label { font-size: var(--ddd-font-size-xs); color: var(--ddd-theme-secondary); font-weight: var(--ddd-font-weight-medium); } .mini-val { font-size: var(--ddd-font-size-xl); font-weight: var(--ddd-font-weight-bold); color: var(--ddd-theme-primary); } .heatmap-grid { display: grid; grid-template-columns: repeat(7, 1fr); gap: var(--ddd-spacing-2); max-width: 500px; margin: 0 auto; } .cell { aspect-ratio: 1; background-color: var(--ddd-theme-polaris-surface-hover); border-radius: var(--ddd-radius-sm); cursor: pointer; transition: all 0.2s; display: flex; align-items: center; justify-content: center; font-size: var(--ddd-font-size-xs); font-weight: var(--ddd-font-weight-bold); color: var(--ddd-theme-secondary); } .cell:hover { transform: scale(1.15); z-index: 10; box-shadow: var(--ddd-shadow-1); } .cell.lvl-1 { background-color: var(--ddd-theme-accent-light); color: var(--ddd-theme-on-primary); } .cell.lvl-2 { background-color: var(--ddd-theme-accent); color: var(--ddd-theme-on-primary); } .cell.lvl-3 { background-color: var(--ddd-theme-primary); color: var(--ddd-theme-on-primary); } .cell.lvl-4 { background-color: var(--ddd-theme-default-text); color: var(--ddd-theme-on-primary); } .legend { display: flex; justify-content: center; gap: var(--ddd-spacing-2); margin-top: var(--ddd-spacing-4); font-size: var(--ddd-font-size-xs); color: var(--ddd-theme-secondary); align-items: center; } .legend-cell { width: 16px; height: 16px; border-radius: var(--ddd-radius-sm); }`]}render(){const t=this._getActivityMap(),e=t.reduce((d,l)=>d+l.count,0),a=t.filter(d=>d.count>0).length,s=Math.round(a/28*100);return n`
      <div class="engagement-card">
        ...
        <div class="consistency-stats">
          ...
          <div class="stat-mini-card"><span class="mini-label">Hari Aktif</span><span class="mini-val">${a} / 28</span></div>
