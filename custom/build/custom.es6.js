var Gt=(k,t)=>()=>{try{return t||k((t={exports:{}}).exports,t),t.exports}catch(e){throw t=0,e}};import{css as Jt,html as at}from"@haxtheweb/haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{PolarisFlexTheme as Wt}from"@haxtheweb/polaris-theme/lib/polaris-flex-theme.js";import"@haxtheweb/haxcms-elements/lib/ui-components/blocks/site-children-block.js";import{DDDSuper as C}from"@haxtheweb/d-d-d/d-d-d.js";import{LitElement as E,css as P,html as n}from"lit";import{I18NMixin as N}from"@haxtheweb/i18n-manager/lib/I18NMixin.js";var Zt=Gt((oe,st)=>{let gt=class extends Wt{static get styles(){return[super.styles,Jt`
        :host {
          display: block;
        }
        aside {
