var Kt=(w,t)=>()=>{try{return t||w((t={exports:{}}).exports,t),t.exports}catch(e){throw t=0,e}};import{css as Gt,html as at}from"@haxtheweb/haxcms-elements/lib/core/HAXCMSLitElementTheme.js";import{PolarisFlexTheme as Jt}from"@haxtheweb/polaris-theme/lib/polaris-flex-theme.js";import"@haxtheweb/haxcms-elements/lib/ui-components/blocks/site-children-block.js";import{DDDSuper as C}from"@haxtheweb/d-d-d/d-d-d.js";import{LitElement as E,css as P,html as n}from"lit";import{I18NMixin as q}from"@haxtheweb/i18n-manager/lib/I18NMixin.js";var Yt=Kt((de,st)=>{let gt=class extends Jt{static get styles(){return[super.styles,Gt`
        :host {
          display: block;
        }
        aside {
          ...
          <div class="breakdown">
            ...
            <div class="table-wrapper">
              <table>
                ...
                <tbody>
                  ${o.slice(0,10).map(u=>n`
                    <tr><td>${u.label}</td><td>${u.pertemuan}</td><td>${u.score}</td></tr>
                  `)}
                </tbody>
              </table>
            </div>
